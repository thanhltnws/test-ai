...
| `market`           | TEXT         | Primary geographic market scope: `domestic` · `regional` · `international`                                                 |
| `sector`           | TEXT         | Denormalized from `icp->>'sector'` for direct filter queries. Same valid values as `icp.sector`.                           |
